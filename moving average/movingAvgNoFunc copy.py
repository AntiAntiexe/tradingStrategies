...
class stocksAnalysis:
    def __init__(self, ticker, Start, End, Period50, Period200):
        super().__init__()
        ...
        self.endDate = End
        self.periods50 = Period50
        self.period200 = Period200

        self.tickerActual = yf.Ticker(self.stock)

    def get_date_x_days_before(self, date_string, num_days_before):
    ...
    def sma50(self):
        self.start_date_x_days_before = self.get_date_x_days_before(self.startDate, self.periods50*2)
